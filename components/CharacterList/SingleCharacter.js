...
export default function SingleCharacter({ character, scaleFactor }) {
  const itemClasses = "table w-48 p-2 m-2 bg-gray-200 text-gray-900 text-center font-medium cursor-pointer border border-gray-300 transition hover:shadow-md"
